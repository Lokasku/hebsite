...
content = do
  div_
    ( do
        p_ "Lorem ipsum dolor sit amet, consectetur adipiscing " <> code_ "elit" <> p_ ", sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad " <> code_ "minim" <> p_ " veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."
        br_ [] <> br_ []
