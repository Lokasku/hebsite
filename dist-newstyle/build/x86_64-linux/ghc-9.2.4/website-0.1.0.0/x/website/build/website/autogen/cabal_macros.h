...
/* package twain-2.1.2.0 */
#ifndef VERSION_twain
#define VERSION_twain "2.1.2.0"
#endif /* VERSION_twain */
#ifndef MIN_VERSION_twain
#define MIN_VERSION_twain(major1,major2,minor) (\
  (major1) <  2 || \
  (major1) == 2 && (major2) <  1 || \
  (major1) == 2 && (major2) == 1 && (minor) <= 2)
#endif /* MIN_VERSION_twain */
...
#define CURRENT_COMPONENT_ID "website-0.1.0.0-inplace-website"
